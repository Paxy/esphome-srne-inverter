...
CONF_INVERTER_ON_LOAD = "inverter_on_load"
CONF_FAULT = "fault"
CONF_SPLIT_PHASE_MODE = "split_phase_mode"
...
CONFIG_SCHEMA = SRNE_INVERTER_COMPONENT_SCHEMA.extend(
    {
        ...
        cv.Optional(CONF_INVERTER_ON_LOAD): binary_sensor.binary_sensor_schema(),
        cv.Optional(CONF_FAULT): binary_sensor.binary_sensor_schema(),
        cv.Optional(CONF_SPLIT_PHASE_MODE): binary_sensor.binary_sensor_schema(),
    }
)
...
async def to_code(config):
    ...
    mapping = {
        ...
        CONF_INVERTER_ON_LOAD: hub.set_inverter_on_load_binary_sensor,
        CONF_FAULT: hub.set_fault_binary_sensor,
        CONF_SPLIT_PHASE_MODE: hub.set_split_phase_mode_binary_sensor,
    }
